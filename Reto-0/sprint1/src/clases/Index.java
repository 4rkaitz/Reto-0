...
public class Index extends JFrame implements ActionListener {
	...
	private ArrayList<Aulas> aula = new ArrayList<Aulas>();
	...
	//Funciones
	public void actualizarCale() {
		int indice = calefactores.indexOf(ae.getSource());
		if (aula(indice).calefactor == 0) {
			aula(indice).calefactor = 1;
			calefactores.get(indice).setBackground(Color.green);
		} else {
			aula(indice).calefactor = 0;
	...
	public void actualizarBD() {		
		try{
			...
			st.executeUpdate("call spINsertAlarma(1)");
